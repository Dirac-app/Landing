  ...
  return (
    <LegalPageLayout title="Privacy Policy" lastUpdated={LAST_UPDATED}>
      ...
      <LegalSection title="Information we collect">
        <p>
          <strong className="font-medium text-ink">Account information.</strong> When you sign up, we
          collect your name, email address, and authentication details needed to create and
          secure your account.
        </p>
        <p>
          <strong className="font-medium text-ink">Email data.</strong> If you connect Gmail or Outlook,
        ...
        <p>
          <strong className="font-medium text-ink">Usage data.</strong> We collect information about how
      ...
      <LegalSection title="How we share information">
        ...
        <ul className="list-disc pl-5 flex flex-col gap-2">
          <li>
            <strong className="font-medium text-ink">Service providers</strong> — hosting, analytics,
            payment processing, email connectivity (e.g. Google, Microsoft), and AI infrastructure
            partners that help us operate Dirac
          </li>
          <li>
            <strong className="font-medium text-ink">Legal requirements</strong> — when required by law,
            regulation, or to protect rights and safety
          </li>
          <li>
            <strong className="font-medium text-ink">Business transfers</strong> — in connection with a
